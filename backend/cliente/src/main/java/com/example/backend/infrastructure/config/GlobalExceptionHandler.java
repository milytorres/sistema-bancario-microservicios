...
import com.example.backend.infrastructure.adapter.in.rest.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> manejarNoEncontrado(ClienteNoEncontradoException ex, HttpServletRequest request) {
        return construirRespuesta(HttpStatus.NOT_FOUND, ex.getMessage(), request, null);
    }

    @ExceptionHandler(ClienteYaExisteException.class)
    public ResponseEntity<ErrorResponseDTO> manejarYaExiste(ClienteYaExisteException ex, HttpServletRequest request) {
